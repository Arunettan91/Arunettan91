...
import com.sap.Interface.SInterfce;

public class SImplementation implements SInterfce {
Connection con;
...
public int login(String username, String password) {
	...
	try{
		...
		while(rs.next()){
			...
			String psswordch =rs.getString("pass");
			
			if(username.equals(usernamech)&& password.equals(psswordch)){
				result = 1;
